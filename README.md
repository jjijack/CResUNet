...
MaCOM 管线利用深度学习模型对高分辨率海洋预报 SST 进行智能订正，使其更接近 CMEMS 全球海洋物理分析预报产品（GLOBAL_ANALYSISFORECAST_PHY_001_024，GLO12）的分析场精度。

**数据流**：高分辨率 MaCOM 预报（1168×1000 网格，168 小时预报时效）作为输入，GLO12 逐时分析场（25×26 网格，1/12°）作为订正目标。模型学习预报与分析场之间的系统性偏差，并在全图尺度上一次完成订正。
